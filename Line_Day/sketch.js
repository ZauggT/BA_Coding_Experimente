...
function setup() {
  ...
  for (let i = 0; i < numRows; i++) {
    ...
    let posXZurich = map(quarterHours, 0, 95, 0 + padding, width / 2 - padding);
...
function lineAnim() {
  ...
  noStroke();
  fill(255, 0, 0);
  ellipse(valeArray[counter][0], valeArray[counter][1], 5);
  fill(0, 0, 255);
  ellipse(valeArray[counter][2], valeArray[counter][3], 5);
